  ...
  return (
    <div className='dark h-screen w-screen bg-background flex flex-col overflow-hidden relative'>
      ...
      <div className='absolute inset-0 overflow-hidden pointer-events-none'>
        <div
          className='absolute top-0 right-1/4 w-[600px] h-[600px] bg-primary/8 rounded-full blur-3xl animate-pulse'
          style={{ animationDuration: '8s' }}
        />
        <div
          className='absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-destructive/6 rounded-full blur-3xl animate-pulse'
          style={{ animationDuration: '10s', animationDelay: '2s' }}
        />
        <div
          className='absolute top-1/2 left-1/2 w-[400px] h-[400px] bg-primary/5 rounded-full blur-3xl animate-pulse'
      ...
      <header className='relative border-b border-border/50 px-6 py-4 glass floating-sm z-10'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center gap-5'>
            ...
            <div className='text-right'>
              <p className='text-[10px] text-foreground uppercase tracking-wider'>Total Gain/Loss</p>
              <p className={`text-lg ${isPortfolioPositive ? 'text-green-primary' : 'text-red-primary'}`}>
                {isPortfolioPositive ? '+' : ''}${totalGain.toFixed(2)} ({totalGainPercent.toFixed(2)}%)
              </p>
            </div>
            <Button
